...
import { confirmEnding } from '@/utils/string'
...
service.interceptors.request.use(
  config => {
    ...
    if(confirmEnding(config.url, "register")) {
      // jdust password
      if(config.data.confirmPassword != config.data.password) {
        console.log("The two password inputs are inconsistent")
